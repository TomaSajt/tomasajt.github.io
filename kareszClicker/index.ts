(function() {
    class Item {
        ...
        unlocked = false;
        count = 0;
        constructor(id:string, itemText:string, price:number, multiplier:number, kps:number, kpc:number, criteria:()=>boolean) {
            this.id = id;
    ...
    var kareszCountText = document.getElementById("kareszCountText")!
    ...
    function buyItem(id:number, num:number) {
        var item = items[id];
    ...
    function loadGame(shouldAsk:boolean) {
        if (shouldAsk) {
    ...
    function addItemToSidebar(id:number) {
        var item = items[id]
        item.unlocked = true;
        var sidebar = document.getElementById("sidebar")!;
    ...
    function removeItemFromSidebar(id:number) {
        var item = items[id]
